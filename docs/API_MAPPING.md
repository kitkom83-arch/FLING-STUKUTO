...
| OroPlay diagnostics | Auth readiness pack | Sanitized createtoken diagnostic and optional read-only balance probe | docs/static script | `src/staging-scripts/oroplayAuthDiagnostic.js`, `src/local-smoke-tests/oroplayAuthDiagnosticSanitizerSmoke.js`, `docs/OROPLAY_LIVE_READINESS.md` | `OROPLAY_BASE_URL`, `OROPLAY_CLIENT_ID`, `OROPLAY_CLIENT_SECRET`, optional `OROPLAY_DIAGNOSTIC_BALANCE=1` | sanitized auth/balance body with token/accessToken/auth header redacted | staging operator diagnostics | none | docs/static verification | Do not enable `OROPLAY_ENABLED=1` until the auth diagnostic returns 200 and balance read-only smoke passes. |
...
- ORO-11D final approval decision evidence pack verification record review record verification record review record verification is review-record-verification-gate-only and static/mock only.
- ORO-11D verifies static ORO-11C verification record review record output, verification metadata, completeness, integrity, deterministic digest evidence, and verification-only disposition only.
...
- ORO-11F final approval decision evidence pack verification record review record verification record review record verification record review is verification-record-review-gate-only and static/mock only.
...
- package smoke aliases: smoke:oro-11f, smoke:oro-11f:detailed.
...
## ORO-11M Separate Successor Phase Authorization Decision Gate Mapping
...
- ORO-11M is docs/static/mock/local smoke only.
...
- ORO-11M route mount and public alias authorization are not issued.
- ORO-11M /api/balance and /api/transaction aliases are not issued.
- ORO-11M live OroPlay API call, external network, wallet mutation, ledger mutation, Prisma write, migration, deploy, production DB, and real-money behavior are not authorized.
- ORO-11M does not approve external call execution.
- helper: src/game-provider-mock/oro11mSeparateSuccessorPhaseAuthorizationDecisionGate.js
- fixtures: src/game-provider-mock/oro11mSeparateSuccessorPhaseAuthorizationDecisionGateFixtures.js
...
## ORO-11O Separate Successor Phase Implementation Readiness Discovery Gate Mapping
...
- ORO-11O is docs/static/mock/local smoke only.
...
- ORO-11O route mount and public alias authorization are not issued.
- ORO-11O /api/balance and /api/transaction aliases are not issued.
- ORO-11O live OroPlay API call, external network, wallet mutation, ledger mutation, Prisma write, migration, deploy, production DB, and real-money behavior are not authorized.
- helper: src/game-provider-mock/oro11oSeparateSuccessorPhaseImplementationReadinessDiscoveryGate.js
- fixtures: src/game-provider-mock/oro11oSeparateSuccessorPhaseImplementationReadinessDiscoveryGateFixtures.js
...
## ORO-11Q Separate Successor Phase Implementation Readiness Decision Gate Mapping
...
- ORO-11Q is docs/static/mock/local smoke only.
...
- ORO-11Q route mount and public alias authorization are not issued.
- ORO-11Q /api/balance and /api/transaction aliases are not issued.
- ORO-11Q live OroPlay API call, external network, wallet mutation, ledger mutation, Prisma write, migration, deploy, production DB, and real-money behavior are not authorized.
- helper: src/game-provider-mock/oro11qSeparateSuccessorPhaseImplementationReadinessDecisionGate.js
- fixtures: src/game-provider-mock/oro11qSeparateSuccessorPhaseImplementationReadinessDecisionGateFixtures.js
...
## ORO-11S Separate Successor Phase Runtime Implementation Authorization Request Gate Mapping
...
- ORO-11S is docs/static/mock/local smoke only.
...
- ORO-11S route mount and public alias authorization are not issued.
- ORO-11S /api/balance and /api/transaction aliases are not issued.
- ORO-11S live OroPlay API call, external network, wallet mutation, ledger mutation, Prisma write, migration, deploy, production DB, and real-money behavior are not authorized.
- Safety markers: no_api_balance, no_api_transaction, no_live_oroplay_api_call, no_external_network, no_wallet_mutation, no_ledger_mutation, no_prisma_write, no_migration, no_deploy, no_production_db, no_real_money, no_secret_token_password_clientSecret.
- helper: src/game-provider-mock/oro11sSeparateSuccessorPhaseRuntimeImplementationAuthorizationRequestGate.js
- fixtures: src/game-provider-mock/oro11sSeparateSuccessorPhaseRuntimeImplementationAuthorizationRequestGateFixtures.js
- detailed smoke: src/local-smoke-tests/oro11sSeparateSuccessorPhaseRuntimeImplementationAuthorizationRequestGateSmoke.js
- wrapper smoke: src/local-smoke-tests/oro11sSmoke.js
- package smoke aliases: smoke:oro-11s, smoke:oro-11s:detailed.

## ORO-11T Separate Successor Phase Runtime Implementation Authorization Decision Gate Mapping
...
- ORO-11T is docs/static/mock/local smoke only.
...
- ORO-11T route mount and public alias authorization are not issued.
- ORO-11T /api/balance and /api/transaction aliases are not issued.
- ORO-11T live OroPlay API call, external network, wallet mutation, ledger mutation, Prisma write, migration, deploy, production DB, and real-money behavior are not authorized.
- Safety markers: no_api_balance, no_api_transaction, no_live_oroplay_api_call, no_external_network, no_wallet_mutation, no_ledger_mutation, no_prisma_write, no_migration, no_deploy, no_production_db, no_real_money, no_secret_token_password_clientSecret.
- helper: src/game-provider-mock/oro11tSeparateSuccessorPhaseRuntimeImplementationAuthorizationDecisionGate.js
- fixtures: src/game-provider-mock/oro11tSeparateSuccessorPhaseRuntimeImplementationAuthorizationDecisionGateFixtures.js
...
## ORO-11V Separate Successor Phase Runtime Implementation Readiness Discovery Gate Mapping
...
- ORO-11V is docs/static/mock/local smoke only.
...
- ORO-11V route mount and public alias authorization are not issued.
- ORO-11V /api/balance and /api/transaction aliases are not issued.
- ORO-11V live OroPlay API call, external network, wallet mutation, ledger mutation, Prisma write, migration, deploy, production DB, and real-money behavior are not authorized.
- Safety markers: no_api_balance, no_api_transaction, no_live_oroplay_api_call, no_external_network, no_wallet_mutation, no_ledger_mutation, no_prisma_write, no_migration, no_deploy, no_production_db, no_real_money, no_secret_token_password_clientSecret.
- helper: src/game-provider-mock/oro11vSeparateSuccessorPhaseRuntimeImplementationReadinessDiscoveryGate.js
- fixtures: src/game-provider-mock/oro11vSeparateSuccessorPhaseRuntimeImplementationReadinessDiscoveryGateFixtures.js
...
Status: CODE-CENTER-REWARD-WALLET-PERSISTENCE-2 keeps the existing backend routes/controllers and adds Prisma-backed storage adapters for local-safe persistence. The default smoke path can still use the in-memory adapter, while the persistence smoke injects Prisma stores and writes only to a guarded local/staging/test PostgreSQL target. No Prisma migration, provider call, cash wallet mutation, deploy, or production DB access is introduced; `cash_credit` remains blocked until an explicit ledger guard exists.

| Module | Screen | Action | Method | Endpoint | Request summary | Response summary | Permission | Audit action | Current status | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Code Center | Campaigns | List campaigns | GET | `/api/admin/code-center/campaigns` | filters | sanitized campaign rows and code counts | `code_center.view` | none | local-safe implemented | Adapter-backed; Prisma store maps to `CodeCampaign` and `CodeCenterCode`. |
...
| Code Center | Codes | Generate codes | POST | `/api/admin/code-center/campaigns/:id/codes` | count, prefix | sanitized code rows | `code_center.manage` | future `code_center.codes.generate` | local-safe implemented | Prisma store persists generated codes and one-time redeem state. |
| Code Center | Redeem logs | List redeem logs | GET | `/api/admin/code-center/redeem-logs` | filters | sanitized redeem log rows | `code_center.view` | none | local-safe implemented | Prisma store maps to `CodeRedeemLog`; no secret-shaped values returned. |
| Member Code Center | Redeem | Redeem code | POST | `/api/code-center/redeem` | member JWT, code | reward wallet entry and redeem result | member self | future `code_center.redeem` | local-safe implemented | Duplicate redeem returns safe failure and reward source is `code_center`. |
| Member Reward Wallet | Rewards | List/summary/history | GET | `/api/member/rewards`, `/api/member/rewards/summary`, `/api/member/rewards/history` | member JWT, filters | member-owned reward wallet views | member self | none | local-safe implemented | Prisma store maps to `MemberRewardWalletEntry` with generic source type/id; non-cash rewards do not mutate cash wallet/ledger. |
