...
const validOro9tFinalizationReviewApprovalBoundaryFixture = fixture(
  "validOro9tFinalizationReviewApprovalBoundaryFixture"
);

const continuationFromOro9sConfirmedFixture = fixture(
  "continuationFromOro9sConfirmedFixture"
);

const finalizationReviewApprovalBoundaryPresentFixture = fixture(
  "finalizationReviewApprovalBoundaryPresentFixture"
);
...
const runtimeFinalizationReviewApprovalNotAuthorizedFixture = fixture(
  "runtimeFinalizationReviewApprovalNotAuthorizedFixture",
  {
    ...
    finalizationReviewApprovalRecordFinalizationReviewApprovalRecordFinalizationReviewApprovalRecordFinalizationReviewApprovalEvidence:
      {
        finalizationReviewApprovalRecordFinalizationReviewApprovalRecordFinalizationReviewApprovalRecordFinalizationReviewApprovalRuntimeApproved: true,
      },
  }
);
...
const longFilenamePresentFixture = fixture("longFilenamePresentFixture", {
  safetyEvidence: {
    longOro9tFilenamePresent: true,
  },
});

function buildOro9tFinalizationReviewApprovalBoundaryFixtures() {
  return [
    validOro9tFinalizationReviewApprovalBoundaryFixture,
    continuationFromOro9sConfirmedFixture,
    finalizationReviewApprovalBoundaryPresentFixture,
...
module.exports = {
  ...
  longFilenamePresentFixture,
  cloneFixture,
  buildOro9tFinalizationReviewApprovalBoundaryFixtures,
};
