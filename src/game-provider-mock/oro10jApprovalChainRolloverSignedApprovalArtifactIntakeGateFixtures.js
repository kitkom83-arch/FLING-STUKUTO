...
const validStaticMockSignedApprovalArtifactIntakeGateFromOro10iFixture = fixture(
  "validStaticMockSignedApprovalArtifactIntakeGateFromOro10iFixture"
);
...
const missingStaticSignedApprovalArtifactIntakeRecordFailFixture = fixture(
  "missingStaticSignedApprovalArtifactIntakeRecordFailFixture",
  {
    safetyEvidence: {
      approvalChainRolloverSignedApprovalArtifactIntakeGatePresent: false,
      staticSignedApprovalArtifactIntakeRecordPresent: false,
    },
  }
);
...
const longFilenameBlockedFixture = fixture("longFilenameBlockedFixture", {
  safetyEvidence: {
    verifiedShortOro10jFilenamesOnly: false,
...
function buildOro10jApprovalChainRolloverSignedApprovalArtifactIntakeGateFixtures() {
  return [
    validStaticMockSignedApprovalArtifactIntakeGateFromOro10iFixture,
