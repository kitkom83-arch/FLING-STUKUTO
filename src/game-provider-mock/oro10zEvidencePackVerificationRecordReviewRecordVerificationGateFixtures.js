...
const DEFAULT_SOURCE_REVIEW_ID = "oro10y-static-evidence-pack-verification-record-review";
const DEFAULT_REVIEW_RECORD_ID = "oro10z-static-evidence-pack-verification-record-review-record";
...
function digestFor(record = {}, overrides = {}) {
  return buildOro10zStaticVerificationRecordReviewRecordDigest({
    phase: ORO10Z_PHASE,
    scope: ORO10Z_SCOPE,
...
function buildFixture(id, overrides = {}) {
  ...
  const base = {
    ...
    sourceReviewEvidence: {
      dependsOnOro10yEvidencePackVerificationRecordReviewRecordGate: true,
      oro10yEvidencePackVerificationRecordReviewRecordGatePassed: true,
      verifiedOro10yWasEvidencePackVerificationRecordReviewRecordGateOnly: true,
      oro10yPhase: "ORO-10Y",
      oro10yScope:
    ...
    safetyEvidence: buildOro10zSafetySummary(),
  };
...
const invalidPriorGateMarkerFixture = buildFixture("invalidPriorGateMarkerFixture", {
  sourceReviewEvidence: {
    oro10yScope: "not_oro10y_review_gate",
    verifiedOro10yWasEvidencePackVerificationRecordReviewRecordGateOnly: false,
  },
});

const missingPriorOro10yReviewFixture = buildFixture("missingPriorOro10yReviewFixture", {
  sourceReviewEvidence: {
    dependsOnOro10yEvidencePackVerificationRecordReviewRecordGate: false,
    oro10yEvidencePackVerificationRecordReviewRecordGatePassed: false,
    verifiedOro10yWasEvidencePackVerificationRecordReviewRecordGateOnly: false,
    oro10yClosed: false,
  },
  verificationRecordReviewRecordEvidence: {
    ...
    oro10yVerificationRecordReviewPresent: false,
...
const verificationRecordReviewDigestMismatchFixture = buildFixture("verificationRecordReviewDigestMismatchFixture", {
  verificationRecordReviewRecordEvidence: {
    ...
    providedStaticVerificationRecordReviewRecordDigest:
      "oro10z-static-verification-record-review-record-verification-digest-ffffffff",
  },
});
...
function buildOro10zEvidencePackVerificationRecordReviewRecordVerificationGateFixtures() {
  return [
    ...
    missingPriorOro10yReviewFixture,
...
module.exports = {
  ...
  secretShapedFieldsAreRedactedFixture,
  noWalletLedgerDbMigrationDeployMarkersFixture,
  buildOro10zEvidencePackVerificationRecordReviewRecordVerificationGateFixtures,
};
