...
} = require("./oro10zEvidencePackVerificationRecordReviewRecordVerificationGate");
...
const ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS = Object.freeze({
  PREPARED: "mock_verification_record_review_record_verification_record_prepared",
  RECORDED_FOR_REVIEW_ONLY: "mock_verification_record_review_record_verification_recorded_for_review_only",
  REJECTED: "mock_verification_record_review_record_verification_record_rejected",
  CHANGES_REQUIRED: "mock_verification_record_review_record_verification_record_changes_required",
  DIGEST_MISMATCH: "mock_verification_record_review_record_verification_record_digest_mismatch",
  MISSING_PRIOR_RECORD: "mock_verification_record_review_record_verification_record_missing_prior_verification",
  MISSING_EVIDENCE: "mock_verification_record_review_record_verification_record_missing_evidence",
  INCOMPLETE: "mock_verification_record_review_record_verification_record_incomplete",
  EXPIRED: "mock_verification_record_review_record_verification_record_expired",
  CONFLICT: "mock_verification_record_review_record_verification_record_conflict",
  INVALID: "mock_verification_record_review_record_verification_record_invalid",
  FAIL_CLOSED: "fail_closed",
});

const ORO11A_RESULT_KEY = "evidencePackVerificationRecordReviewRecordVerificationRecordGateResult";
const DEPENDS_ON_ORO10Z_KEY = "dependsOnOro10zEvidencePackVerificationRecordReviewRecordVerificationGate";
const ORO10Z_PASSED_KEY = "oro10zEvidencePackVerificationRecordReviewRecordVerificationGatePassed";
const VERIFIED_ORO10Z_ONLY_KEY = "verifiedOro10zWasEvidencePackVerificationRecordReviewRecordVerificationGateOnly";
const NEXT_PHASE_KEY = "nextPhaseSeparateApprovalRequired";
const DEFAULT_FIXTURE_ID = "validOro11aEvidencePackVerificationRecordReviewRecordVerificationRecordGateFromOro10zFixture";
...
const RECORD_BLOCKED_STATUSES = Object.freeze([
  ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.DIGEST_MISMATCH,
  ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.MISSING_PRIOR_RECORD,
  ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.MISSING_EVIDENCE,
  ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.INCOMPLETE,
  ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.EXPIRED,
  ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.CONFLICT,
  ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.INVALID,
...
const REQUIRED_TRUE_FLAGS = Object.freeze([
  "oro10zPredecessorPresent",
  "continuationFromOro10zConfirmed",
  "oro10zEvidencePackVerificationRecordReviewRecordVerificationGatePresent",
  ...
  "evidencePackVerificationRecordReviewRecordSourceFromOro10zOnly",
  "oro10zVerificationRecordReviewAsSource",
  ...
  "verifiedShortOro11aFilenamesOnly",
]);
...
const SAFE_STATUS_ALIASES = Object.freeze({
  prepared: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.PREPARED,
  record_prepared: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.PREPARED,
  recorded: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.RECORDED_FOR_REVIEW_ONLY,
  recorded_for_review_only:
    ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.RECORDED_FOR_REVIEW_ONLY,
  review_only_recorded:
    ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.RECORDED_FOR_REVIEW_ONLY,
  rejected: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.REJECTED,
  changes_required: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.CHANGES_REQUIRED,
  digest_mismatch: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.DIGEST_MISMATCH,
  missing_prior_record:
    ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.MISSING_PRIOR_RECORD,
  missing_evidence: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.MISSING_EVIDENCE,
  incomplete: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.INCOMPLETE,
  expired: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.EXPIRED,
  conflict: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.CONFLICT,
  conflicting: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.CONFLICT,
  invalid: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.INVALID,
  fail_closed: ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.FAIL_CLOSED,
});
...
function buildOro11aStaticVerificationRecordReviewRecordDigest(record = {}) {
  ...
  return `oro11a-static-verification-record-review-record-verification-digest-${hash.toString(16).padStart(8, "0")}`;
}

function buildOro11aSafetySummary(overrides = {}) {
  return deepMerge(
    {
...
function buildOro11aDefaultSourceReviewEvidence() {
  return {
    [DEPENDS_ON_ORO10Z_KEY]: true,
    [ORO10Z_PASSED_KEY]: true,
    [VERIFIED_ORO10Z_ONLY_KEY]: true,
    oro10zPhase: ORO10Z_PHASE,
    oro10zScope: ORO10Z_SCOPE,
    oro10zClosed: true,
    oro10zReviewStatus: ORO10Z_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_GATE_STATUS.PREPARED,
    oro10zStaticVerificationRecordReviewDigest: "oro10z-static-verification-record-review-digest-reference",
    oro10zVerificationRecordReviewAsSource: true,
...
function normalizeStatus(rawStatus) {
  ...
  if (!value) return ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.PREPARED;
  if (Object.values(ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS).includes(value)) {
    return value;
  }
  const alias = value.toLowerCase().replace(/[^a-z0-9]+/g, "_").replace(/^_+|_+$/g, "");
  return SAFE_STATUS_ALIASES[alias] || ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.INVALID;
}
...
function statusFrom(sources) {
  ...
  return ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.PREPARED;
}

function buildOro11aDefaultRecordReviewRecordShell() {
  const safetyEvidence = buildOro11aSafetySummary();
  const baseRecord = {
    phase: ORO11A_PHASE,
    evidencePackVerificationRecordReviewRecordGateScope: ORO11A_SCOPE,
    evidencePackVerificationRecordReviewRecordStatus:
      ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.PREPARED,
    sourceVerificationRecordReviewId: "oro10z-static-evidence-pack-verification-record-review",
    verificationRecordReviewRecordId: "oro11a-static-evidence-pack-verification-record-review-record",
    evidencePackVerificationRecordReviewRecordSourceModel:
      "oro10z_static_mock_evidence_pack_verification_record_review_record",
    oro10zVerificationRecordReviewPresent: true,
  ...
  const digest = buildOro11aStaticVerificationRecordReviewRecordDigest({
    phase: ORO11A_PHASE,
    scope: ORO11A_SCOPE,
  ...
  return {
    ...
    sourceReviewEvidence: buildOro11aDefaultSourceReviewEvidence(),
...
function buildOro11aEvidencePackVerificationRecordReviewRecord(input = {}) {
  const baseline = buildOro11aDefaultRecordReviewRecordShell();
  ...
  return Object.freeze({
    ...
    oro10zVerificationRecordReviewPresent: readBooleanFrom(
      [record, merged],
      "oro10zVerificationRecordReviewPresent",
      true
    ),
...
function normalizeOro11aEvidencePackVerificationRecordReviewRecordInput(input = {}) {
  const baseline = buildOro11aDefaultRecordReviewRecordShell();
  const merged = deepMerge(baseline, isPlainObject(input) ? input : {});
  ...
  const verificationRecordReviewRecord = buildOro11aEvidencePackVerificationRecordReviewRecord(input);
  ...
  const normalized = {
    ...
    phase: readStringFrom(recordSources, "phase", ORO11A_PHASE),
    ...
    oro10zVerificationRecordReviewPresent:
      verificationRecordReviewRecord.oro10zVerificationRecordReviewPresent,
    oro10wVerificationRecordReferenceOnlyPresent:
    ...
    [DEPENDS_ON_ORO10Z_KEY]: readBooleanFrom(sourceSources, DEPENDS_ON_ORO10Z_KEY, true),
    [ORO10Z_PASSED_KEY]: readBooleanFrom(sourceSources, ORO10Z_PASSED_KEY, true),
    [VERIFIED_ORO10Z_ONLY_KEY]: readBooleanFrom(sourceSources, VERIFIED_ORO10Z_ONLY_KEY, true),
    oro10zPhase: readStringFrom(sourceSources, "oro10zPhase", ORO10Z_PHASE),
    oro10zScope: readStringFrom(sourceSources, "oro10zScope", ORO10Z_SCOPE),
    oro10zClosed: readBooleanFrom(sourceSources, "oro10zClosed", true),
    oro10zReviewStatus: readStringFrom(
      sourceSources,
      "oro10zReviewStatus",
...
function assertOro11aNoRuntimeAuthorization(input) {
  const fixture = normalizeOro11aEvidencePackVerificationRecordReviewRecordInput(input);
  const blockers = [];
  for (const key of REQUIRED_FALSE_FLAGS) {
    if (fixture[key] !== false) blockers.push(`${key}_not_allowed_in_oro11a`);
  }
  for (const key of [
    "verifiedNoFinalApprovalIssued",
    "verifiedNoReviewAuthorityOccurred",
...
function validationBlockersFor(input) {
  const fixture = normalizeOro11aEvidencePackVerificationRecordReviewRecordInput(input);
  const blockers = [];
  if (fixture.phase !== ORO11A_PHASE) blockers.push("invalid_oro11a_phase");
  if (fixture.evidencePackVerificationRecordReviewRecordGateScope !== ORO11A_SCOPE) {
    blockers.push("invalid_oro11a_evidence_pack_verification_record_review_record_scope");
  }
  if (!fixture[DEPENDS_ON_ORO10Z_KEY] || !fixture[ORO10Z_PASSED_KEY] || !fixture[VERIFIED_ORO10Z_ONLY_KEY]) {
    blockers.push("missing_oro10z_evidence_pack_verification_record_review_record_verification_gate");
  }
  if (fixture.oro10zPhase !== ORO10Z_PHASE || fixture.oro10zScope !== ORO10Z_SCOPE || !fixture.oro10zClosed) {
    blockers.push("invalid_oro10z_evidence_pack_verification_record_review_record_verification_gate");
  }
  ...
  if (!fixture.oro10zVerificationRecordReviewPresent) blockers.push("missing_oro10z_verification_record_review");
  ...
  blockers.push(...assertOro11aNoRuntimeAuthorization(fixture).blockers);
...
function verificationRecordReviewRecordOutcomeFor(status, blockers) {
  if (status === ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.FAIL_CLOSED) {
    return "fail_closed";
  }
  if (RECORD_BLOCKED_STATUSES.includes(status) || blockers.length > 0) return "verification_blocked";
  if (status === ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.RECORDED_FOR_REVIEW_ONLY) {
    return "recorded_for_review_only_non_runtime";
  }
  if (status === ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.REJECTED) {
    return "rejected_recorded_non_runtime";
  }
  if (status === ORO11A_EVIDENCE_PACK_VERIFICATION_RECORD_REVIEW_RECORD_VERIFICATION_RECORD_GATE_STATUS.CHANGES_REQUIRED) {
...
function buildOutput(result, blockers, fixture) {
  ...
  const output = {
    ...
    [ORO11A_RESULT_KEY]: result,
    [DEPENDS_ON_ORO10Z_KEY]: pass && fixture[DEPENDS_ON_ORO10Z_KEY],
    [ORO10Z_PASSED_KEY]: pass && fixture[ORO10Z_PASSED_KEY],
    [VERIFIED_ORO10Z_ONLY_KEY]: pass && fixture[VERIFIED_ORO10Z_ONLY_KEY],
    oro10zPhase: pass ? fixture.oro10zPhase : HOLD,
    oro10zScope: pass ? fixture.oro10zScope : HOLD,
    oro10zClosed: pass && fixture.oro10zClosed,
...
function evaluateOro11aEvidencePackVerificationRecordReviewRecordVerificationRecordGate(
  input = buildOro11aDefaultRecordReviewRecordShell()
) {
  const fixture = normalizeOro11aEvidencePackVerificationRecordReviewRecordInput(input);
...
function validateOro11aEvidencePackVerificationRecordReviewRecordVerificationRecordGate(input = {}) {
  return evaluateOro11aEvidencePackVerificationRecordReviewRecordVerificationRecordGate(input);
}

const buildOro11aEvidencePackVerificationRecordReviewRecordVerificationEvidence =
  buildOro11aEvidencePackVerificationRecordReviewRecord;
const buildOro11aStaticVerificationRecordReviewRecordVerificationDigest =
  buildOro11aStaticVerificationRecordReviewRecordDigest;
const normalizeOro11aEvidencePackVerificationRecordReviewRecordVerificationInput =
  normalizeOro11aEvidencePackVerificationRecordReviewRecordInput;
const buildOro11aEvidencePackVerificationRecordReviewRecordVerificationRecord =
  buildOro11aEvidencePackVerificationRecordReviewRecord;
const buildOro11aStaticVerificationRecordReviewRecordVerificationRecordDigest =
  buildOro11aStaticVerificationRecordReviewRecordDigest;
const normalizeOro11aEvidencePackVerificationRecordReviewRecordVerificationRecordInput =
  normalizeOro11aEvidencePackVerificationRecordReviewRecordInput;
...
module.exports = {
  ...
  buildOro11aDefaultSourceReviewEvidence,
  buildOro11aEvidencePackVerificationRecordReviewRecord,
  buildOro11aEvidencePackVerificationRecordReviewRecordVerificationEvidence,
  buildOro11aEvidencePackVerificationRecordReviewRecordVerificationRecord,
  buildOro11aStaticVerificationRecordReviewRecordDigest,
  buildOro11aStaticVerificationRecordReviewRecordVerificationDigest,
  buildOro11aStaticVerificationRecordReviewRecordVerificationRecordDigest,
  normalizeOro11aEvidencePackVerificationRecordReviewRecordInput,
  normalizeOro11aEvidencePackVerificationRecordReviewRecordVerificationInput,
  normalizeOro11aEvidencePackVerificationRecordReviewRecordVerificationRecordInput,
