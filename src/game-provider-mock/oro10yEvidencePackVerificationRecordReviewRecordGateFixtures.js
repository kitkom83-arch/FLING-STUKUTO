...
const DEFAULT_SOURCE_REVIEW_ID = "oro10x-static-evidence-pack-verification-record-review";
const DEFAULT_REVIEW_RECORD_ID = "oro10y-static-evidence-pack-verification-record-review-record";
...
function digestFor(record = {}, overrides = {}) {
  return buildOro10yStaticVerificationRecordReviewRecordDigest({
    phase: ORO10Y_PHASE,
    scope: ORO10Y_SCOPE,
...
function buildFixture(id, overrides = {}) {
  ...
  const base = {
    ...
    sourceReviewEvidence: {
      dependsOnOro10xEvidencePackVerificationRecordReviewGate: true,
      oro10xEvidencePackVerificationRecordReviewGatePassed: true,
      verifiedOro10xWasEvidencePackVerificationRecordReviewGateOnly: true,
      oro10xPhase: "ORO-10X",
      oro10xScope:
    ...
    safetyEvidence: buildOro10ySafetySummary(),
  };
...
const invalidPriorGateMarkerFixture = buildFixture("invalidPriorGateMarkerFixture", {
  sourceReviewEvidence: {
    oro10xScope: "not_oro10x_review_gate",
    verifiedOro10xWasEvidencePackVerificationRecordReviewGateOnly: false,
  },
});

const missingPriorOro10xReviewFixture = buildFixture("missingPriorOro10xReviewFixture", {
  sourceReviewEvidence: {
    dependsOnOro10xEvidencePackVerificationRecordReviewGate: false,
    oro10xEvidencePackVerificationRecordReviewGatePassed: false,
    verifiedOro10xWasEvidencePackVerificationRecordReviewGateOnly: false,
    oro10xClosed: false,
  },
  verificationRecordReviewRecordEvidence: {
    ...
    oro10xVerificationRecordReviewPresent: false,
...
const verificationRecordReviewDigestMismatchFixture = buildFixture("verificationRecordReviewDigestMismatchFixture", {
  verificationRecordReviewRecordEvidence: {
    ...
    providedStaticVerificationRecordReviewRecordDigest:
      "oro10y-static-verification-record-review-record-digest-ffffffff",
  },
});
...
function buildOro10yEvidencePackVerificationRecordReviewRecordGateFixtures() {
  return [
    ...
    missingPriorOro10xReviewFixture,
...
module.exports = {
  ...
  secretShapedFieldsAreRedactedFixture,
  noWalletLedgerDbMigrationDeployMarkersFixture,
  buildOro10yEvidencePackVerificationRecordReviewRecordGateFixtures,
};
