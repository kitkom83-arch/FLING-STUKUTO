...
const validStaticMockSignedApprovalArtifactVerificationRecordReviewGateFromOro10lFixture = fixture(
  "validStaticMockSignedApprovalArtifactVerificationRecordReviewGateFromOro10lFixture"
);
...
const missingOro10lPredecessorFailFixture = fixture("missingOro10lPredecessorFailFixture", {
  predecessorEvidence: {
    dependsOnOro10lApprovalChainRolloverSignedApprovalArtifactVerificationRecordBoundary: false,
    oro10lApprovalChainRolloverSignedApprovalArtifactVerificationRecordBoundaryPassed: false,
    verifiedOro10lWasSignedApprovalArtifactVerificationRecordBoundaryOnly: false,
    oro10lClosed: false,
  },
...
const missingStaticSignedApprovalArtifactVerificationRecordReviewFailFixture = fixture(
  "missingStaticSignedApprovalArtifactVerificationRecordReviewFailFixture",
  {
    safetyEvidence: {
      approvalChainRolloverSignedApprovalArtifactVerificationRecordReviewGatePresent: false,
...
const longFilenameBlockedFixture = fixture("longFilenameBlockedFixture", {
  safetyEvidence: {
    verifiedShortOro10mFilenamesOnly: false,
...
function buildOro10mApprovalChainRolloverSignedApprovalArtifactVerificationRecordReviewGateFixtures() {
  return [
    validStaticMockSignedApprovalArtifactVerificationRecordReviewGateFromOro10lFixture,
