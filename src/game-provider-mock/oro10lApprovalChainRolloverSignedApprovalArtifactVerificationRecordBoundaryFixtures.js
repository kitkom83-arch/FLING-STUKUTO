...
const validStaticMockSignedApprovalArtifactVerificationRecordBoundaryFromOro10kFixture = fixture(
  "validStaticMockSignedApprovalArtifactVerificationRecordBoundaryFromOro10kFixture"
);
...
const missingOro10kPredecessorFailFixture = fixture("missingOro10kPredecessorFailFixture", {
  predecessorEvidence: {
    dependsOnOro10kApprovalChainRolloverSignedApprovalArtifactVerificationGate: false,
    oro10kApprovalChainRolloverSignedApprovalArtifactVerificationGatePassed: false,
    verifiedOro10kWasSignedApprovalArtifactVerificationGateOnly: false,
    oro10kClosed: false,
  },
...
const missingStaticSignedApprovalArtifactVerificationRecordFailFixture = fixture(
  ...
  {
    safetyEvidence: {
      approvalChainRolloverSignedApprovalArtifactVerificationRecordBoundaryPresent: false,
...
const longFilenameBlockedFixture = fixture("longFilenameBlockedFixture", {
  safetyEvidence: {
    verifiedShortOro10lFilenamesOnly: false,
...
function buildOro10lApprovalChainRolloverSignedApprovalArtifactVerificationRecordBoundaryFixtures() {
  return [
    validStaticMockSignedApprovalArtifactVerificationRecordBoundaryFromOro10kFixture,
