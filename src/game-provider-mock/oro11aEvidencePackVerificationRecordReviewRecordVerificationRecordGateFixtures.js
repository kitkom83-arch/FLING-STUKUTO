...
const DEFAULT_SOURCE_REVIEW_ID = "oro10z-static-evidence-pack-verification-record-review";
const DEFAULT_REVIEW_RECORD_ID = "oro11a-static-evidence-pack-verification-record-review-record";
...
function digestFor(record = {}, overrides = {}) {
  return buildOro11aStaticVerificationRecordReviewRecordDigest({
    phase: ORO11A_PHASE,
    scope: ORO11A_SCOPE,
...
function buildFixture(id, overrides = {}) {
  ...
  const base = {
    ...
    sourceReviewEvidence: {
      dependsOnOro10zEvidencePackVerificationRecordReviewRecordVerificationGate: true,
      oro10zEvidencePackVerificationRecordReviewRecordVerificationGatePassed: true,
      verifiedOro10zWasEvidencePackVerificationRecordReviewRecordVerificationGateOnly: true,
      oro10zPhase: "ORO-10Z",
      oro10zScope:
    ...
    safetyEvidence: buildOro11aSafetySummary(),
  };
...
const invalidPriorGateMarkerFixture = buildFixture("invalidPriorGateMarkerFixture", {
  sourceReviewEvidence: {
    oro10zScope: "not_oro10z_verification_gate",
    verifiedOro10zWasEvidencePackVerificationRecordReviewRecordVerificationGateOnly: false,
  },
});

const missingPriorOro10zReviewFixture = buildFixture("missingPriorOro10zReviewFixture", {
  sourceReviewEvidence: {
    dependsOnOro10zEvidencePackVerificationRecordReviewRecordVerificationGate: false,
    oro10zEvidencePackVerificationRecordReviewRecordVerificationGatePassed: false,
    verifiedOro10zWasEvidencePackVerificationRecordReviewRecordVerificationGateOnly: false,
    oro10zClosed: false,
  },
  verificationRecordReviewRecordEvidence: {
    ...
    oro10zVerificationRecordReviewPresent: false,
...
const verificationRecordReviewDigestMismatchFixture = buildFixture("verificationRecordReviewDigestMismatchFixture", {
  verificationRecordReviewRecordEvidence: {
    ...
    providedStaticVerificationRecordReviewRecordDigest:
      "oro11a-static-verification-record-review-record-verification-digest-ffffffff",
  },
});
...
function buildOro11aEvidencePackVerificationRecordReviewRecordVerificationRecordGateFixtures() {
  return [
    ...
    missingPriorOro10zReviewFixture,
...
module.exports = {
  ...
  secretShapedFieldsAreRedactedFixture,
  noWalletLedgerDbMigrationDeployMarkersFixture,
  buildOro11aEvidencePackVerificationRecordReviewRecordVerificationRecordGateFixtures,
};
