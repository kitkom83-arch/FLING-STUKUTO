...
const RELATED_FILES = [
  ...
  "docs/ORO_10R_FINAL_APPROVAL_DECISION_REVIEW_GATE.md",
...
const summary = [
  ...
  { key: "oro10r", label: "oro-10r", status: "PENDING" },
  { key: "oro10s", label: "oro-10s", status: "PENDING" },
  { key: "oro10t", label: "oro-10t", status: "PENDING" },
  { key: "oro10u", label: "oro-10u", status: "PENDING" },
  { key: "oro10v", label: "oro-10v", status: "PENDING" },
...
const steps = [
  ...
  {
    name: "node --check oro10rFinalApprovalDecisionReviewGateSmoke",
    command: nodeCommand,
    args: ["--check", "src/local-smoke-tests/oro10rFinalApprovalDecisionReviewGateSmoke.js"],
    summaryKey: "syntax",
  },
  {
    name: "node --check oro10rSmoke",
    command: nodeCommand,
    args: ["--check", "src/local-smoke-tests/oro10rSmoke.js"],
    summaryKey: "syntax",
  },
  {
    name: "node --check oro10sFinalApprovalDecisionRecordGateSmoke",
    command: nodeCommand,
    args: ["--check", "src/local-smoke-tests/oro10sFinalApprovalDecisionRecordGateSmoke.js"],
    summaryKey: "syntax",
  },
  {
    name: "node --check oro10sSmoke",
    command: nodeCommand,
    args: ["--check", "src/local-smoke-tests/oro10sSmoke.js"],
    summaryKey: "syntax",
  },
  {
    name: "node --check oro10tFinalApprovalDecisionRecordVerificationGateSmoke",
    command: nodeCommand,
    args: ["--check", "src/local-smoke-tests/oro10tFinalApprovalDecisionRecordVerificationGateSmoke.js"],
    summaryKey: "syntax",
  },
  {
    name: "node --check oro10tSmoke",
    command: nodeCommand,
    args: ["--check", "src/local-smoke-tests/oro10tSmoke.js"],
    summaryKey: "syntax",
  },
  {
    name: "node --check oro10uFinalApprovalDecisionEvidencePackGateSmoke",
    command: nodeCommand,
    args: ["--check", "src/local-smoke-tests/oro10uFinalApprovalDecisionEvidencePackGateSmoke.js"],
    summaryKey: "syntax",
  },
  {
    name: "node --check oro10uSmoke",
    command: nodeCommand,
    args: ["--check", "src/local-smoke-tests/oro10uSmoke.js"],
    summaryKey: "syntax",
  },
  {
    name: "node --check oro10vFinalApprovalDecisionEvidencePackVerificationGateSmoke",
    command: nodeCommand,
    args: ["--check", "src/local-smoke-tests/oro10vFinalApprovalDecisionEvidencePackVerificationGateSmoke.js"],
    summaryKey: "syntax",
  },
  {
    name: "node --check oro10vSmoke",
    command: nodeCommand,
    args: ["--check", "src/local-smoke-tests/oro10vSmoke.js"],
    summaryKey: "syntax",
  },
  {
  ...
  {
    name: "npm run smoke:oro-10r",
    command: npmCommand,
    args: npmArgs(["run", "smoke:oro-10r"]),
    summaryKey: "oro10r",
  },
  {
    name: "npm run smoke:oro-10r:detailed",
    command: npmCommand,
    args: npmArgs(["run", "smoke:oro-10r:detailed"]),
    summaryKey: "oro10r",
  },
  {
    name: "npm run smoke:oro-10s",
    command: npmCommand,
    args: npmArgs(["run", "smoke:oro-10s"]),
    summaryKey: "oro10s",
  },
  {
    name: "npm run smoke:oro-10s:detailed",
    command: npmCommand,
    args: npmArgs(["run", "smoke:oro-10s:detailed"]),
    summaryKey: "oro10s",
  },
  {
    name: "npm run smoke:oro-10t",
    command: npmCommand,
    args: npmArgs(["run", "smoke:oro-10t"]),
    summaryKey: "oro10t",
  },
  {
    name: "npm run smoke:oro-10t:detailed",
    command: npmCommand,
    args: npmArgs(["run", "smoke:oro-10t:detailed"]),
    summaryKey: "oro10t",
  },
  {
    name: "npm run smoke:oro-10u",
    command: npmCommand,
    args: npmArgs(["run", "smoke:oro-10u"]),
    summaryKey: "oro10u",
  },
  {
    name: "npm run smoke:oro-10u:detailed",
    command: npmCommand,
    args: npmArgs(["run", "smoke:oro-10u:detailed"]),
    summaryKey: "oro10u",
  },
  {
    name: "npm run smoke:oro-10v",
    command: npmCommand,
    args: npmArgs(["run", "smoke:oro-10v"]),
    summaryKey: "oro10v",
  },
  {
    name: "npm run smoke:oro-10v:detailed",
    command: npmCommand,
    args: npmArgs(["run", "smoke:oro-10v:detailed"]),
    summaryKey: "oro10v",
  },
  {
